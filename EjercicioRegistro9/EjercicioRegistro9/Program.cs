    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                //Usamos un "if" y un "if else" para verificar la cantidad ingresada por el usuario
                if (Num1 == 0)
                {
            ...
            //Con el "while" se verifica que la cantidad ingresada no es positiva, y si no lo es, se repite la primera pregunta hasta que sea correcta
            while (Num1 < 0);
            
            //Se declara y crea un "array" con el "struct" de Auto, y que tiene un tamaño definido con "Num1"
